...
class BubbleGraph {
    ...
    initVis(){
        ...
        vis.centerScale = d3.scalePoint().padding(1).range([0, vis.width]);
    ...
    updateVis(){
        ...
        console.log("vis.nodes here", vis.nodes);
        ...
        function splitBubbles() {
            ...
            let newDomain = vis.filteredData.map(function(d){ return d["genre"]; })
            console.log("newDomain", newDomain)
            vis.centerScale.domain(newDomain);
            console.log("centerScale range", vis.centerScale("pop"))

            // @v4 Reset the 'x' force to draw the bubbles to their year centers
            vis.simulation.force('x', d3.forceX().strength(0.05).x(function(d){
                return vis.centerScale(d["genre"]);
            }));

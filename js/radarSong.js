...
class RadarSong {
    ...
    wrangleData(){
        ...
        console.log("song display data", vis.displayData);
    ...
    updateVis() {
        ...
        console.log("picked song", vis.pickedSong);
        console.log("radar song vis.timeData", vis.timeData);
        ...
        vis.averageData.push(
            {
                valence: singleSong['0'].valence,
                acousticness: singleSong['0'].acousticness,
                danceability: singleSong['0'].danceability,
                energy: singleSong['0'].energy,
        ...
        console.log("average data" , vis.averageData[0]);
        ...
        vis.svg
            ...
            .attr("stroke-width", 3)
            .attr("stroke", d => {
                return vis.colorScale(vis.pickedSong)
            })
            .attr("fill", d => {
                return vis.colorScale(vis.pickedSong)
            })
